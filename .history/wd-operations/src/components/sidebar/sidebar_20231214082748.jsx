              ...
              <div className="space-y-1">
                ...
                {person?.role !== "Driver" && (
                  <>
                    ...
                    <div className="mx-2">
                      <div className="h-[120px] bg-gradient-to-br from-[#010615] to-[#402a1d]  bg-opacity-80 border-white/30 border border-opacity-40 overflow-y-auto scrollbar-hide rounded-lg my-2">
