...
export const BoardView = () => {
  ...
  return isLoaded ? (
    <div className="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-2 md:flex p-4 rounded-lg justify-between h-screen w-full md:space-x-5 mx-1 md:mx-5 md:pr-8 my-3 md:pb-5">
    ...
    <>
      <div className="items-center h-auto w-full flex justify-center text-primary bg-muted-foreground/95 bg-opacity-40">
