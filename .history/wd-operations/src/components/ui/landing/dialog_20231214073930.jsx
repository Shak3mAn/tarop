    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "relative overflow-y-auto h-screen sm:h-auto sm:fixed z-[100] grid w-full md:w-[78%] gap-4 rounded-b-lg border-none bg-white shadow-xl animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:max-w-lg sm:rounded-lg sm:zoom-in-90 data-[state=open]:sm:slide-in-from-bottom-0 md:max-w-fit",
            className
          )}
          {...props}
        >
    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            "relative overflow-y-auto h-screen sm:h-auto sm:fixed z-[100] grid w-full md:w-[78%] gap-4 rounded-b-lg border-none bg-white shadow-2xl animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:max-w-lg sm:rounded-lg sm:zoom-in-90 data-[state=open]:sm:slide-in-from-bottom-0 md:max-w-fit",
            className
          )}
          {...props}
        >
    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          onPointerDownOutside={(e) => e.preventDefault()}
          className={cn(
            "relative overflow-y-auto h-screen sm:h-auto sm:fixed z-[100] grid w-1/2 md:w-[78%] gap-4 rounded-b-lg border-none bg-white shadow-2xl animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:max-w-lg sm:rounded-lg sm:zoom-in-90 data-[state=open]:sm:slide-in-from-bottom-0 md:max-w-fit",
            className
          )}
          {...props}
        >
