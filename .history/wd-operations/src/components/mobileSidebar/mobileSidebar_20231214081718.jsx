  ...
  return (
    <SheetPrimitive.Root>
      ...
      <SheetContent side="left" className="px-0">
        {/* <Sidebar /> */}
        <div className="space-y-4 py-4 flex flex-col h-full bg-[#020817] text-white overflow-hidden">
          <div className="px-3 pb-1 pt-2 flex-1 flex flex-col justify-between">
            <div>
              {/* Logo */}
              <div className="-mt-2 rounded-lg pt-4 pb-1">
                <Link
                  href="/dashboard"
                  ...
                  <>
                    {adminRoutes.map((route) => (
                      <Link
                        ...
                        href={route.href}
                        className={cn(
                          "text-md group flex px-3 py-2 w-full justify-start font-normal cursor-pointer active:text-white hover:bg-white/10 rounded-lg transition-all ease-in-out duration-300",
                          pathname === route.href
            ...
            <div className="px-3 py-1 pb-6 scrollbar-hidden flex-col-reverse">
              ...
              <button
                ...
                className={cn(
                  "text-md group flex px-3 py-2 w-full justify-start font-normal cursor-pointer hover:text-white hover:bg-white/10 rounded-lg transition-all ease-in-out duration-300 text-zinc-400"
                )}
              >
                <div className="flex items-center flex-1">
