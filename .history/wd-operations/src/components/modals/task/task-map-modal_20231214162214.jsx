...
export const TaskMapModal = () => {
  ...
  useEffect(() => {
    if (isDistance.isDistance?.duration != null) {
      setMeta({
        ...meta,
  ...
  }, [isDistance.isDistance?.duration]);
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (meta.duration.includes("hour")) {
        ...
        // console.log("Date New Time:", newTime);
        const editDate = new Date(newTime);

        // console.log("Date Edit Time:", editDate);
                            ...
                            <div className="space-y-4">
                              <Form {...form}>
                                <form onSubmit={form.handleSubmit(onSubmit)}>
                                  ...
                                  <div className=" pt-4 space-x-2 flex items-end absolute justify-end w-full bottom-18 right-10">
                                    <DialogPrimitive.Close asChild>
                                      <Button
                                        disabled={loading}
                                        variant="outline"
