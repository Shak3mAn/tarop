...
export const TeamModal = ({
  ...
  const { addTeam, teamMapMeta, driverMapMeta, teams } =
    useTeamStore();
    ...
    <>
      <DialogPrimitive.Root>
        <DialogPrimitive.Trigger asChild>
          ...
          >
            <Plus className="absolute h-5 w-5 transition-all" />
          </button>
              ...
              <div className="space-y-4">
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <div className="pt-10 pb-20  sm:pb-0 space-x-2 flex items-center justify-end w-full">
