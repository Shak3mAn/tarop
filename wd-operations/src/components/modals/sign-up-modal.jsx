...
import Port from "../../../public/general/tarop-port.jpg";
...
export const SignUpModal = ({ className }) => {
            ...
            <div className="flex md:grid md:grid-cols-10">
              <div className="hidden md:flex md:col-span-6">
                <Image
                  alt="Port"
                  src={Port}
                  className="rounded-tl-lg contrast-75 opacity-95 object-cover h-full rounded-bl-lg overflow-hidden"
                />
              </div>
