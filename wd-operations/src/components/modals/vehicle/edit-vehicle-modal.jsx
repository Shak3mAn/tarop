...
export const EditVehicleModal = ({ initialData, className }) => {
  ...
  const onSubmit = async (data) => {
    const notificationData = {
      ...
      title: "Vehicle",
      action: "Updated",
      description: `Vehicle: ${data.team} has been updated`,
    }
          ...
          <DialogHeader className="pt-4 flex flex-row items-center justify-start">
            <div className="flex space-x-2">
              ...
              <div className="flex flex-col">
                ...
                <DialogDescription>Edit Existing Vehicle</DialogDescription>
              </div>
            </div>
          </DialogHeader>
