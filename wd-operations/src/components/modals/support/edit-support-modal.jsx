...
export const EditSupportModal = ({ initialData, className }) => {
  ...
  const onSubmit = async (data) => {
    const notificationData = {
      ...
      title: "Support",
      action: "Updated",
      description: `Support: ${data.fullName} has been updated`
    }
    
    try {
      setLoading(true);
      updateSupport(data.id, data);
          ...
          <DialogHeader className="pt-4 flex flex-row items-center justify-start">
            <div className="flex space-x-2">
              ...
              <div className="flex flex-col">
                <DialogTitle>Support Coordinator</DialogTitle>
                <DialogDescription>
                  Edit Existing Support Coordinator
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
