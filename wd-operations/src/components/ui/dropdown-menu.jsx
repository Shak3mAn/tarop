...
// TODO: Figure out whether `ref` is really a necessity
    ...
    return (
        <DropdownMenuPrimitive.Portal>
            <DropdownMenuPrimitive.Content
                ...
                className={cn(
                    "z-[99] min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
                    className
                )}
                {...props}
            />
...
const DropdownMenuNotificationItem = ({ className, inset, ...props }) => {
    return (
        <DropdownMenuPrimitive.Item
            className={cn(
...
DropdownMenuNotificationItem.displayName = "DropdownMenuNotificationItem"
